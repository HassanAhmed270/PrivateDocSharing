...
import { storeSession } from '../utils/authStorage.js';
...
function Register() {
  ...
  async function handleSubmit(event) {
    ...
    try {
      ...
      const organization = await createOrganization(form.organizationName.trim(), session.token);
      storeSession({
        token: session.token,
        user: {
          ...session.user,
  ...
  return (
    <AuthCard
      ...
      description={`Create your account and your organization workspace. Registration is limited to ${organizationEmailDomain} organization email addresses.`}
    >
      <form className="space-y-5" onSubmit={handleSubmit} noValidate>
        ...
        <FormField
          ...
          placeholder="Acme Secure Workspace"
